...
function setUpSongContainers(){
    for(let i=0; i<5; i++){
        ...
        songContainer.innerHTML+=`
            ...
            <div class="play-song">
                <a id="link-song">
                    <img class="play-button" src="play-circle-solid.svg" alt="Play-Logo" srcset="">
                </a>
            </div>
        `
...
async function updateSongs(classIdx){
    ...
    //     </div>
    //     <div class="play-song">
    //         <a href="${song.id}"><img class="play-button" src="play-circle-solid.svg" alt="Play-Logo" srcset=""></a>
